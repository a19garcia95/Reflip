...
class ResearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post researches_url, params: { research: { price: @research.price, title: @research.title } }
    end
  ...
  test "should update research" do
    patch research_url(@research), params: { research: { price: @research.price, title: @research.title } }
